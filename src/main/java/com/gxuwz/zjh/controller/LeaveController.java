...
public class LeaveController {
    ...
    private final String LIST_ADMIN = "leave/leave_list";//管理员
    private final String LIST_USER = "leave/leave_list_user";//辅导员
    private final String LIST_INST = "leave/leave_list_inst";//学生
    ...
    //饼图
    @GetMapping(value ="/statsReason")
    public Map<String, Integer> getLeaveReasonStats() {
        return iLeaveService.getLeaveReasonStats();
    }
